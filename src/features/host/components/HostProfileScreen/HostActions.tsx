...
const CreateNewEventDialog = dynamic(
    () => import("../Dialog/CreateNewEventDialog"),
    {
        ssr: false,
        loading: () => (
            <button
...
export default function HostActions() {
    return (
        <div className="relative mt-6 bg-white rounded-md p-3 flex items-center justify-between border-2 border-[#E0E0E0]">
