			...
			<DialogContent className="dialog-base p-4 max-h-[600px] flex flex-col">
				...
				<div className="flex flex-col gap-[12px]">
					<div className="flex items-center gap-[10px]">
						...
						<div className="px-2 bg-[#0FD850] rounded-full">
							<p className="text-white text-base font-medium">Host</p>
						</div>
					</div>

					<div className="flex items-center gap-1">
						<RatingStarsEditable rating={rating} setRating={setRating} />
					</div>

					<p className="text-base text-white font-medium">Some things to think about in your review</p>

					<div className="flex items-center gap-[10px]">
						<div className="rounded-full bg-[#282828] px-3 py-1">
							<p className="text-base text-white font-medium">Moderation</p>
						</div>
						<div className="rounded-full bg-[#282828] px-3 py-1">
							<p className="text-base text-white font-medium">Speaker quality</p>
						</div>
						<div className="rounded-full bg-[#282828] px-3 py-1">
							<p className="text-base text-white font-medium">Value gain</p>
						</div>
					</div>
				...
				<DialogFooter>
					<button
						...
						disabled={loading || !review.trim() || rating === 0} // Disable if loading or incomplete
					>
						Submit
					</button>
				</DialogFooter>
