            ...
            <div className="flex-1 mx-auto flex flex-col w-full max-w-[732px]">
                <div className="flex items-center gap-3 p-3 border-b border-b-stroke-1">
                    ...
                    <div className="flex-1 flex items-center gap-3">
                        ...
                        <p className="text-secondary text-xs font-medium">Alex Block</p>
                    </div>

                    <div className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 16 16" fill="none">
                            <path d="M3 7C2.45 7 2 7.45 2 8C2 8.55 2.45 9 3 9C3.55 9 4 8.55 4 8C4 7.45 3.55 7 3 7ZM13 7C12.45 7 12 7.45 12 8C12 8.55 12.45 9 13 9C13.55 9 14 8.55 14 8C14 7.45 13.55 7 13 7ZM8 7C7.45 7 7 7.45 7 8C7 8.55 7.45 9 8 9C8.55 9 9 8.55 9 8C9 7.45 8.55 7 8 7Z" fill="white" fillOpacity="0.6" />
                        </svg>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col m-3">
                    <div className="bg-card-2 rounded-md p-3 flex items-center gap-4">
                        ...
                        <div className="bg-card-1 p-3 rounded-[80px] flex items-center justify-center">
                            <p className="text-white text-xs font-medium uppercase">Post daily to earn points</p>
                        </div>
                    </div>
        ...
        <div className="flex flex-col w-full">
            <div className="flex flex-col items-end gap-4">
                <div className="flex items-center gap-3">
                    <span className="text-secondary text-xs uppercase font-medium">{m.timestamp}</span>
                    <div className="w-8 h-8 bg-card-1 rounded-[4px]"></div>
                    <span className="text-secondary text-xs uppercase font-medium">{m.author}</span>
                </div>
            ...
            <div className="flex flex-col items-start gap-4">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-card-1 rounded-[4px]"></div>
                    <span className="text-secondary text-xs uppercase font-medium">Point system</span>
                </div>
