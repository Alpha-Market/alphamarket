        ...
        <OnBoardLayout>
            ...
            <div className="sm:fixed sm:bottom-0 sm:inset-x-0 absolute sm:top-auto top-[10%] z-[100] bg-card-1 w-full sm:max-w-full max-w-[422px] border border-stroke-1 sm:rounded-b-none rounded-xl p-4 flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-b-stroke-1 pb-4">
                    ...
                    <p className="text-white text-sm font-medium uppercase">Create Group</p>
                ...
                <div className={cn(
                ...
                )}>
                    {
                        group_photo ?
                            <>
                                <img src={URL.createObjectURL(group_photo)} alt="" className="w-[388px] h-[82px] object-cover" />
                            ...
                            :
                            <>
                                <p className="text-secondary text-xs font-bold uppercase">Add Photo</p>

                                {/* Upload Icon */}
                                <div className="cursor-pointer relative z-[100]" onClick={() => {
                ...
                <div className="flex flex-col gap-2">
                    <label htmlFor="bio" className="text-secondary text-xs font-normal uppercase">name</label>

                    <input type="text" className="rounded-lg bg-card-1 p-3 text-white text-sm" onChange={e => {
                        setGroupName(e.target.value);
                    }} />
                </div>

                <div className="flex flex-col gap-2">
                    <label htmlFor="bio" className="text-secondary text-xs font-normal uppercase">Ticker</label>
                ...
                <div className="flex flex-col gap-2 border-b border-b-stroke-1 pb-4">
                    <label htmlFor="bio" className="text-secondary text-xs font-normal uppercase">Description </label>
